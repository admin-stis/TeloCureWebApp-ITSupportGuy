...
<div class="tab-section">
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="patient">
            		...
            		<div class="bottom-left caption slider-text">
                        <!-- <h3 style="">Feel better in minutes with TeloCure</h3>
                        <h5 style="">
 ...
 -->
                        ...
                        <span class="tab-title" style="margin-bottom:5px">Feel better in minutes<br>with TeloCure</span>
                        <br>
                        <span class="tab-sub-title">
                            Get quick and professional medical service at all times from<br>board-certified doctors.
                        </span>
                        <br>
	                    <div class="pt-10 btn-area">
                            <a href="{{url('register/patient')}}" class="drop-btn"><span>JOIN NOW</span></a>
                            <a class="drop-btn" href="{{url('login/patient')}}"><span>SIGN IN</span></a>
                        </div>
                    </div>
            ...
            <div role="tabpanel" class="tab-pane" id="doctor">
                ...
                <div class="bottom-left caption slider-text">
                    ...
                    <span class="tab-sub-title">Partner with TeloCure to provide patients with urgent care and wellness visit.<br>TeloCure makes it convenient for both you and your patients.
                    </span>
                ...
                <img src="{{asset('assets/img/tab/doctor.png')}}" alt="Doctor" >
                <!-- <img src="{{asset('assets/img/tab/paitent.png')}}" alt="Patient"> -->
            ...
            <div role="tabpanel" class="tab-pane" id="hospital">
                <div class="caption slider-text">
                    <span class="tab-title" style="margin-bottom:5px">Easier Hospital Visits</span><br>
                    <span class="tab-sub-title">Search for hospitals and make appointments easily
	                    ...
	                    <div class="pt-10  btn-area">
                            <a href="#" class="drop-btn">JOIN NOW</a>
                            <a href="{{url('/login/hospital')}}" class="drop-btn">SIGN IN</a>
                        </div>
                </div>
                <img src="{{asset('assets/img/tab/hospital.png')}}" alt="Hospital" >
                 
            </div>
            
            <div role="tabpanel" class="tab-pane" id="e-prescription">
                <div class="caption slider-text">
                    <span class="tab-title" style="margin-bottom:5px">Convenient and flexible<br>medication information</span><br>
                    <span class="tab-sub-title" >
                        Get reliable, secure and confidential medication<br>information through our e-prescription service.
                    </span>
                </div>
                <img src="{{asset('assets/img/tab/e-prescription.png')}}" alt="E-prescription" >
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="">
                            ...
                            <img src="{{asset('assets/img/heloDoc_mobile.png')}}" alt="HeloDoc Mobile App" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row m-0">
                    <div class="col-lg-6 col-sm-12">
                        <div class="welcome-item welcome-left">
                            <img src="{{asset('assets/img/home/why_heloDoc.jpeg')}}" alt="HeloDoc">
                        </div>
                    </div>
                    <div class="col-lg-6 col-sm-12">
                ...
                <div class="row m-0">
                    ...
                    <div class="col-lg-5">
                        <div class="speciality-item speciality-right">
                            <img src="{{asset('assets/img/home/heloDoc.png')}}" alt="Speciality">
                ...
                <div class="row m-0">
                    <div class="col-lg-7">
                        <div class="speciality-left">
                            <div class="section-title-two">
                                <!-- <span>Speciality</span> -->
                                <h2>See how an online medical visit works.</h2>
                            </div>
                            <div class="speciality-item">
                                <div class="row m-0">
