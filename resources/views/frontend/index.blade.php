                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-3 col-md-12">
                        <div class="">
                            ...
                            <img class="mobile-app" src="{{asset('assets/img/heloDoc_mobile.png')}}" alt="TeloCure Mobile App" />
                        </div>
                    </div>
                </div>
            </div>
...
@php echo __('Through TeloCure visit your doctor from anywhere and at anytime virtually. Sign up to TeloCure and book your appointment to see your doctor for a regular check-up or for urgent care, get connected to a doctor immediately. Watch the video to see how an online visit works.');@endphp
                    ...
                    <div class="col-lg-5 col-sm-12" style="padding-left: 15px;">
                        <div class="speciality-item speciality-right video">
                              ...
                              <iframe src="https://www.youtube.com/embed/17jfOmoPhQo" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                    </div>
                </div>
            </div>
