...
<div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item">
            <img src="{{asset('assets/img/slider/slide-4.jpg')}}" alt="Hospital" style="width:100%;">
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-4">
                <div class="google-play">
                    ...
                    <p>
                        ...
                        you medical care online anytime, anywhere on your smartphone.
                    </p>
                    <h6>Patient App</h6>
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="google-play">
                    ...
                    <a href="https://play.google.com/store/apps/details?id=com.provider.telocure&hl=en_US"><img
                            src="{{asset('assets/img/google-play.png')}}" alt="Doctor App"></a>
                </div>
            </div>
        ...
        <div class="row m-0">
            <div class="col-lg-6 col-sm-12">
                <div class="welcome-item welcome-left">
                    <img src="{{asset('assets/img/home/why_heloDoc.jpg')}}" alt="TeloCure">
                </div>
            </div>
            <div class="col-lg-6 col-sm-12">
                        ...
                        <li class="wow fadeInUp" data-wow-delay=".5s">
                            ...
                            <div class="welcome-inner">
                                ...
                                <p>
                                    ...
                                    and your family safe by getting medical attention. With the ongoing COVID-19
                            ...
                            <div class="col-lg-12 col-sm-12 wow fadeInUp" data-wow-delay=".3s"
                                ...
                                <div class="speciality-inner">
                                    ...
                                    <p>
                                        ...
                                        COVID-19 pandemic we encourage you to stay home and stay safe.
                                    </p>
                                </div>
                            </div>
