...
<div id="carousel_demo" class="carousel slide" data-ride="carousel" data-interval="5000" data-pause="hover">
    ...
    <div class="carousel-inner" style="">
        ...
        <img src="{{asset('assets/img/slider/slide-4-2.jpg')}}" alt="Patient" style="width:100%;">

      </div> -->
       {{--  <div class="carousel-item text-center">
            <div class="" style="">
                <!-- <iframe id="carousel-video" class="embed-responsive-item" src="{{asset('assets/TeloCure.mp4')}}" allow=" autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
  -->
                <video id="carousel_video1" poster="{{asset('assets/img/slider/poster.png')}}" controls>
                    <source src="{{asset('assets/TeloCure.mp4')}}" type="video/mp4">
       ...
       {{--  <div class="carousel-item ">
            <img src="{{asset('assets/img/slider/slide-1.jpg')}}" alt="Doctor" style="width:100%;">
        </div> --}}
            ...
            <div class="col-sm-12">
                <ul class="nav nav-tabs tabs-left" role="tablist">
                    <li role="presentation" class="active">
                        ...
                        <a href="#patient" aria-controls="home" role="tab" data-toggle="tab" class="active"
                            aria-selected="true">Patient</a>
                    </li>
                    <li role="presentation"><a href="#doctor" aria-controls="profile" role="tab"
                            data-toggle="tab">Doctor</a></li>
                    <li role="presentation"><a href="#hospital" aria-controls="messages" role="tab"
                            data-toggle="tab">Hospital</a></li>
                    <li role="presentation"><a href="#e-prescription" aria-controls="settings" role="tab"
                            data-toggle="tab">E-prescription</a></li>
                </ul>
            </div>
            <!-- <div class="col-sm-12">
...
-->
    ...
    <div role="tabpanel" class="tab-pane" id="doctor">
        ...
        <div class="bottom-left caption slider-text">
            ...
            <div class="pt-10 btn-area" style="margin-left:0px;">
                ...
                <a href="{{url('/register/doctor')}}" class="btn drop-btn"
                    style="pointer-events: all; cursor: pointer;">JOIN NOW</a>
                <a href="{{url('/login/doctor')}}" class="btn drop-btn"
                    style="pointer-events: all; cursor: pointer;">SIGN IN</a>
    ...
    <div role="tabpanel" class="tab-pane" id="hospital">
        <img src="{{asset('assets/img/tab/hospital-resized.jpg')}}" alt="Hospital">
 ...
 <br> -->
            ...
            <div class="pt-10  btn-area" style="margin-left:0px;">
                <a href="{{url('service/hospital')}}" class="more nav-link" style="padding:0px;">More
                    information</a><br>
        ...
        <div class="row">
            <div class="col-sm-8 col-lg-8 col-md-12">
                <div class="google-play">
                    <h4 class="patient">Patient Android App</h4>
                    <p>
                        Get TeloCure on your phone and get immediate medical attention. We designed this app to provide
                        you medical care online anytime, anywhere on your smartphone.<br><br>
                    </p>

                    <div class="col-sm-8 col-lg-8 col-md-12">
                        <h6>Play Store Download Link</h6>
                        <a href="https://play.google.com/store/apps/details?id=com.user.telocure&hl=en"><img
                                src="{{asset('assets/img/google-play-resized.png')}}" alt="Patient App"></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-4 col-lg-4 col-md-12">
                <div class="">
                    ...
                    <img class="mobile-app" src="{{asset('assets/img/telocure_mobile.png')}}"
                        alt="TeloCure Mobile App" />
                </div>
            </div>
        </div>
        ...
        <div class="row  ">
            <div class="col-sm-8 col-lg-8 col-md-12 ">
                <div class="google-play">
                    ...
                    <h4 class="patient">Doctor Android App</h4>
                    <p>
                        Download our app to provide patients with urgent care at your convenience.<br><br>
                    </p>

                    <div class="col-sm-8 col-lg-8 col-md-12">
                        <h6>Play Store Download Link</h6>
                        <a href="https://play.google.com/store/apps/details?id=com.provider.telocure&hl=en"><img
                                src="{{asset('assets/img/google-play-resized.png')}}" alt="Doctor App"></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-4 col-lg-4 col-md-12">
                <div class="">
                    <!-- <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Praesentium eaque omnis corporis, animi aspernatur tempora.</p>
                            <i class="icofont-laboratory"></i> -->
                    <img class="mobile-app" src="{{asset('assets/img/heloDoc_mobile.png')}}"
                        alt="TeloCure Mobile App" />
                </div>
            </div>
        </div>
        ...
        <div class="row m-0">
            <div class="col-lg-6 col-sm-12">
                <div class="welcome-item welcome-left">
                    <img src="{{asset('assets/img/home/why_heloDoc_resized.jpg')}}" alt="TeloCure">
                </div>
            </div>
            <div class="col-lg-6 col-sm-12">
                    ...
                    <ul>
                        <li class="wow fadeInUp" data-wow-delay=".3s">
                            ...
                            <div class="welcome-inner">
                                ...
                                <p>
                                    It’s similar to an office visit, but instead of going over to the doctor’s office
                                    you can consult them from the comfort of your home, work or anywhere that is
                                    convenient for you. Our certified physicians can assess and make a diagnosis,
                                    recommend the necessary treatment and send you your required prescription.
                                </p>
                            </div>
                        </li>
                        <li class="wow fadeInUp" data-wow-delay=".5s">
                            ...
                            <div class="welcome-inner">
                                ...
                                <p>
                                    More than ever TeloCure is needed as it helps with social distancing. Keep yourself
                                    and your family safe by getting medical attention. With the ongoing
                                    pandemic we encourage you to stay home and stay safe.
                                </p>
                            </div>
                        </li>
        ...
        <div class="row m-0">
            <div class="col-lg-7 com-sm-12">
                <div class="speciality-left">
                    ...
                    <div class="speciality-item">
                        <div class="row m-0">
                            <div class="col-lg-12 col-sm-12 wow fadeInUp" data-wow-delay=".3s"
                                style="padding-left: 0px;">
                                <div class="speciality-inner">
                                    <!-- <i class="icofont-check-circled"></i> -->
                                    <!-- <h3>Child Care</h3> -->
                                    <p>
                                        It's similar to an office visit, but instead of going over to the doctor’s
                                        office you can consult them from the comfort of your home, work or anywhere that
                                        is convenient for you. Our certified physicians can assess and make a diagnosis,
                                        recommend the necessary treatment and send you your required prescription.
                                    </p>

                                    <p>
                                        More than ever TeloCure is needed as it helps with social distancing. Keep
                                        yourself and your family safe by getting medical attention. With the ongoing
                                         pandemic we encourage you to stay home and stay safe.
                                    </p>
                                </div>
                            </div>
            ...
            <div class="col-lg-5">
                <div class="speciality-item speciality-right">
                    <img src="{{asset('assets/img/home/why_heloDoc_resized.jpg')}}" alt="Speciality">
...
<section class="speciality-area pb-100">
    <div class="container p-0">
        <div class="row m-0">
                        ...
                        <div class="row m-0">
                            <div class="col-lg-12 col-sm-12 wow fadeInUp" data-wow-delay=".3s" style="padding-left: 0;">
                                <div class="speciality-inner">
                                    ...
                                    <!-- <h3>Child Care</h3> -->
                                    <p>
                                        A health care platform to find doctors near you, book an appointment, consult
                                        via video on your smartphone, and get medication information through
                                        e-prescription services. <br> Our doctors are available 24/7 to meet your
                                        medical needs.<br> Get access to primary health care from anywhere in Bangladesh
            ...
            <div class="col-lg-5">
                <div class="speciality-item speciality-right">
                    <img src="{{asset('assets/img/home/heloDoc-resized.jpg')}}" alt="Speciality">
                    <!-- <div class="speciality-emergency">
                                <div class="speciality-icon">
                                    <i class="icofont-ui-call"></i>
                                </div>
        ...
        <div class="row m-0">
            <div class="col-lg-7">
                <div class="speciality-left">
                    ...
                    <div class="speciality-item">
                        <div class="row m-0">
                            <div class="col-sm-12 col-lg-12 wow fadeInUp" data-wow-delay=".3s"
                                style="padding-left: 0px;">
                                <div class="speciality-inner">
                                    <!-- <i class="icofont-check-circled"></i> -->
                                    <!-- <h3>Child Care</h3> -->
                                    <p>
                                        Through TeloCure visit your doctor from anywhere and at anytime virtually. Sign
                                        up to TeloCure and book your appointment to see your doctor for a regular
                                        check-up or for urgent care, get connected to a doctor immediately. Watch the
                                        video to see how an online visit works.
                                    </p>
                                </div>
                            </div>
                            <!-- <div class="col-sm-6 col-lg-6 wow fadeInUp" data-wow-delay=".5s">
            ...
            <div class="col-lg-5 col-sm-12" style="padding-left: 15px;">
                <div class="speciality-item speciality-right video">
                    ...
                    <iframe src="https://www.youtube.com/embed/17jfOmoPhQo" frameborder="0"
