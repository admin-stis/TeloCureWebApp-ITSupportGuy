                    ...
                    <div class="col-lg-4  col-md-3 col-sm-7">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <form class="form-inline subscribe-mail" action="{{url('subscribe')}}" method="post">
                                ...
                                {{-- <div class="subscribe-mail"> --}}
                                  <input type="email" class="form-control" id="footer-email" required placeholder="Email Address" name="email" style="border:0;border-radius: 0;">
                        ...
                        <div class="col-lg-4 col-md-3 col-sm-7">
                            <ul class="social">
                                ...
                                <li class="list-inline-item"><a href="https://twitter.com/TeloCure"><i class="icofont-twitter"></i></a></li>
                                <li class="list-inline-item"><a href="https://www.instagram.com/telocure/"><i class="icofont-instagram"></i></a></li>
                                {{--
                                ...
                                --}}
                                <li class="list-inline-item"><a href="https://www.youtube.com/watch?v=YPdOR-I6zHU"><i class="icofont-youtube"></i></a></li>
                                <li class="list-inline-item"><a href="https://www.linkedin.com/company/telocureapp/" target="_blank"><i class="icofont-linkedin"></i></a></li>
                                <li class="list-inline-item"><a href="https://www.pinterest.com/Telocure" target="_blank"><i class="icofont-pinterest"></i></a></li>
                            </ul>
                                    </div>
                </div>
                <hr>
                        ...
                        <div class="footer-item">
                            <div class="footer-quick">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="https://www.sslcommerz.com" target="_blank"><img src="{{asset('assets/img/ssl.png')}}" width="100%" alt="ssl"></a>
