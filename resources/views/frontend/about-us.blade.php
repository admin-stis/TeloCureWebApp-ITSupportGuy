                ...
                <div class="row" style="margin-bottom:40px">
                    ...
                    <div class="col-lg-6">
                        <div class="privacydetails-inner-left">
                            ...
                            <img src="{{asset('assets/img/about-us/sristylogo.jpg')}}" width="100%" style="padding-top:20px;border:1px solid #18166a"; alt="Service">
                        </div>
                    </div>
                </div>
