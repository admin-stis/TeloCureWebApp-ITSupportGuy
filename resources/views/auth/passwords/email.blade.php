            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {{--<form method="POST" action="{{ route('password.email') }}">--}}
                        ...
                        @elseif(Session::has('error-notify-temporary'))
                            <ul><p class="alert {{ Session::get('alert-class', 'alert-danger') }}">{{ Session::get('error-notify-temporary') }}</p></ul>
                        @endif
                        
                        <form method="POST" action="{{ url('sendTempOtp/'.$title) }}">
                        @csrf
