...
<!-- Content Header (Page header) -->
    @php
        ...
        for($i = 0; $i < count($rev); $i++)
        {
            ...
            $income = intval(substr($rev[$i]['title'],0,-2));
      ...
      <div class="container-fluid">
        ...
        <div class="row" style="">
            ...
            <div class="card  earning-card" style="height:100%;">
              ...
              <div class="earning-reports">
                  <div class="btn-group w-100 mb-2">
                    <a id="we" class="col-sm-6 col-md-12 earning-bar btn btn-default active" href="#weeklyEarning" data-filter="all"><h4>Earnings</h4></a>
                    <a id="stmnts" class="col-sm-6 col-md-12 earning-bar btn btn-default" href="#statements" data-filter="1"><h4>Statements</h4></a>
                  </div>
          ...
          @if(Session::has('profile-success'))
              <section class="col-md-12 col-lg-12 colsm-12" style="margin-top: 10px;"><ul><p class="alert {{ Session::get('alert-class', 'alert-success') }}">{{ Session::get('profile-success') }}</p>
              </ul></section>
          @endif
              ...
              <div class="card-body">
                <ul class="todo-list" data-widget="todo-list" style="width: 50%; float: left;">
                  ...
                  <li>
                    ...
                    <span class="text col-md-6 col-sm-12">
                    @if(isset($bank_info['accountNumber'])){{$bank_info['accountNumber']}} @endif</span>
                  </li>
                  ...
                  <li>
                    ...
                    <span class="">:</span>
                    <span class="text col-md-6 col-sm-12">@if(isset($doctorInfo['district'])){{$doctorInfo['district']}} @endif</span>
                  </li>
                ...
                <ul class="todo-list" data-widget="todo-list" style="width: 50%; float: left;">
                  ...
                  <li>
                    ...
                    <span class="">:</span>
                    <span class="text  col-md-4 col-sm-12">@if(isset($bank_info['swiftCode'])){{$bank_info['swiftCode']}}@endif</span>
                  </li>
                  <li>
                    <span class="text  col-md-7 col-sm-12">Date of Birth</span>
                    <span class="">:</span>
                    <span class="text  col-md-4 col-sm-12">@if(isset($doctorInfo['dateOfBirth'])){{$doctorInfo['dateOfBirth']}}@endif</span>
                  </li>
                  <li>
                  ...
                  <li>
                    <span class="text  col-md-7 col-sm-12">Postal Code</span>
                    <span class="">:</span>
                    <span class="text  col-md-4 col-sm-12">@if(isset($doctorInfo['districtId'])){{$doctorInfo['districtId']}}@endif</span>
                  </li>
