          ...
          <section class="col-lg-12 " style="margin-top: 10px;">
            ...
            <div class="card">
              ...
              <div class="card-body row">
                ...
                @php 
                //dd($presDoc); 
                $presDoc['vital'] = json_decode($presDoc[0]['vital'],TRUE);
                $presDoc['medicineMap'] = json_decode($presDoc[0]['medicineMap'],TRUE);
                @endphp
                <ul class="todo-list" data-widget="todo-list">
                  <li><span class="">Blood Pressure : @if($presDoc['vital']['bpm']){{$presDoc['vital']['bpm']}} @else N/A @endif</span></li>
                  <li><span class="">Measure Time : @if($presDoc['vital']['measureTime']){{$presDoc['vital']['measureTime']->get()->format('d-m-Y')}}  @else N/A @endif</span></li>
                  <li><span class="">Respiration : @if($presDoc['vital']['resp']){{$presDoc['vital']['resp']}} @else N/A @endif</span></li>
                  <li><span class="">Temparature : @if($presDoc['vital']['temp']){{$presDoc['vital']['temp']}} @else N/A @endif</span></li>
                </ul>
              ...
              <div class="col-sm-12 col-md-6 col-lg-6 todo-list connectedSortable"  data-widget="todo-list" style="padding: 10px;margin-top: 20px;">
                ...
                <h5>Disease : @if(isset($presDoc[0]['disease'])) {{$presDoc[0]['disease']}} @else N/A @endif</h4>
                <hr>
                <h4>Medicine</h4>
                  ...
                  <table class="table table-bordered" style="margin-top:20px;">
                      ...
                      <tbody>
                      @foreach($presDoc['medicineMap'] as $key => $val)
