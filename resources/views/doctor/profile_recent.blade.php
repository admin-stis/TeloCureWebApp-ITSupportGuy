                ...
                <div class="row profile">
                    ...
                    <div class="col-md-9">
                        <ul class="nav nav-tabs profile-tab">
                            <li class="col-md-6 col-sm-12 text-center active "><a data-toggle="tab" href="#info">Basic Information</a></li>
                            {{-- <li class="col-md-4 text-center "><a data-toggle="tab" href="#doc">Upload Documents</a></li> --}}
                            <li class="col-md-6 col-sm-12 text-center"><a data-toggle="tab" href="#bank">Bank Account Information</a></li>
                        </ul>
                            ...
                            <div id="bank" class="tab-pane fade">
                                <div class="col-md-12">
                                    ...
                                    <div class="well well-sm col-sm-6">
                                        ...
                                        {{$doctorProfile['bankName']}}</div>
                                    <div class="well well-sm col-sm-12">
                                        <label><i  class="fa fa-map-marker"></i> Branch Name :</label>{{$doctorProfile['branchName']}}</div>
