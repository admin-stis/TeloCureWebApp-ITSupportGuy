  ...
  <section class="content">
    ...
    <div class="col-md-9">
            ...
            {{-- <div class="well well-sm col-sm-12">
               ...
               <div class="well well-sm col-sm-12">
                <label><i  class="fa fa-map-marker"></i> Location :</label>@if(isset($userProfile ['district'])){{$userProfile ['district']}}@endif</div>
                {{-- <div class="well well-sm col-sm-12">
                ...
                <div class="well well-sm col-sm-12">
                    ...
                    @if(isset($userProfile ['totalCount'])){{$userProfile ['totalCount']}}@endif
                </div>
                {{-- <div class="well well-sm col-sm-12">
