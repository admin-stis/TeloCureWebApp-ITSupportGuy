        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-6">
              ...
              <div class="small-box bg-success">
                <div class="inner">
                  <h3>{{$activeUser}}<sup style="font-size: 20px"></sup></h3>
    ...
    <div class="card">
        <div class="card-header">
            <div class="col-md-12 text-center">
                <span class="margin:0 auto;display:table;"><i class="fas fa-list mr-1"></i> List of Patient</span>
            </div>
            <div class="col-md-6">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if(isset($item['uid']))
                                                            ...
                                                            <a class="btn btn-primary btn-sm" href="{{url('admin/pprofile/'.trim($item['uid']))}}">View profile</a>
