                    ...
                    <!-- <div class="privacyalldetails" style="border:2px solid red;"> -->
                       ...
                       <div class="col-lg-6">
                           <div class="privacydetails" style="padding-top:15px;">
                               <h2>Why HeloDoc</h2>
                               <p>HeloDoc utilizes machine learning and artificial intelligence to provide the best quality of care
to patients with the highest level of convenience. With HeloDoc hospitals will be able to take
                            ...
                            <br>
                                <div class="row">
                                    <div class="col-md-4" style="margin-bottom:10px;">
                                          ...
                                          <div class="text-left">
                                              <a href="{{url('register/hospital')}}" class="btn drop-btn"><span>JOIN NOW</span></a>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="privacydetails" style="padding-top:15px;">
                            ...
                            <p><b>Keep track of hospital analytics: </b>With HeloDoc keep track of your analytics and generated revenue more</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="privacydetails-inner-left">
        ...
        <section class="servicehospital-area">
            <div class="container">
                <div class="servicehospital-title">
                    ...
                    <p>Use HeloDoc as a platform to provide quality health care to patients across the country. Subscribe to one of our annual plans.</p>
                </div>
                <div class="row">
                        ...
                        <div class="servicehospitalblog-item">
                            ...
                            <div class="servicehospitalblog-bottom">
                                ...
                                <div class="package-content">
                                    ...
                                    <li>Revenue share per transaction on doctor fee will be 80%(hospital)/20%(Helodoc)</li>
                        ...
                        <div class="servicehospitalblog-item">
                            <div class="servicehospitalblog-bottom">
                                ...
                                <div class="package-content">
                                    ...
                                    <li>Revenue share per transaction on doctor fee 80%(hospital)/20%(Helodoc)</li>
                                    <li>Web analytics dashboard,Web access, Doctors Access control</li>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="servicehospitalblog-item">
                            <div class="servicehospitalblog-bottom">
                                ...
                                <div class="package-content">
                                    ...
                                    <li>Revenue share per transaction on doctor fee 80%(hospital)/20%(Helo doc)</li>
                                    <li>Web analytics dashboard, Web access, Doctors Access control</li>
                                </div>
                            </div>
                        </div>
                ...
                <form method="POST" action="{{url('sethospitaluser')}}">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control" id="lname" name="email" placeholder="">
                    </div>
                  </div>
                  ...
                  <div class="form-row">
                    ...
                    <input type="text" class="form-control" id="hospitalName" name="hospitalName" placeholder="">
                    </div>
                    <div class="form-group col-md-4">
                      <label for="haddress">Hospital Address</label>
                      <input type="text" class="form-control" id="hospitalAddress" name="hospitalAddress" placeholder="">
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        <label for="hname">Subscription</label>
                        <select name="plan" type="text" class="form-control" id="subscription" placeholder="" required>
