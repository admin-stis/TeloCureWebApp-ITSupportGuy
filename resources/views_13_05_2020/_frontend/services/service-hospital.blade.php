                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="privacydetails" style="padding-top:15px;">
                            ...
                            <p><b>Keep track of hospital analytics: </b>With TeloCure keep track of your analytics and generated revenue more</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="privacydetails-inner-left">
        ...
        <section class="servicehospital-area">
            <div class="container">
                <div class="servicehospital-title">
                    ...
                    <p>Use TeoCure as a platform to provide quality health care to patients across the country. Subscribe to one of our annual plans.</p>
                </div>
                <div class="row">
