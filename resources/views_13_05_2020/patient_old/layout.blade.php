...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Shadiqur Rahman</a>
        </div>
      </div>
  ...
  <!-- /.content-wrapper -->
  <footer class="main-footer" style="background: rgb(9,57,59) !important;border-top: 1px solid #dee2e6;color: #fff !important;padding: 0.5rem;text-align: center;">
    <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="http://mysoftheaven.com/">My Softheaven (BD) Ltd.</a></strong>
    All rights reserved.
