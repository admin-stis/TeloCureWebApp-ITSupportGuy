...
<div class="content-header">
    ...
    <div class="card">
                    <div class="row card-header">
                        <div class="col-md-6">
                            <h3 class="card-title">
                                <i class="fas fa-chart-pie mr-1"></i>List of Doctor
                            </h3>
                        </div>
                        <div class="col-md-6">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if(isset($item['uid']))
                                                            ...
                                                            <a @if(isset($item['approve']) && $item['approve'] == false) class="btn  btn-sm btn-danger disabled"; @else class="btn  btn-sm btn-danger"; @endif href="{{url('admin/rejactDoctor/'.trim($item['uid']))}}">Reject</a>
                                                        @else
